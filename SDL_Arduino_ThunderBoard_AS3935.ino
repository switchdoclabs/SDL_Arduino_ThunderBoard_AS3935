/* Modified SwitchDoc Labs October 2017
*/
...
//SDL_Arduino_ThunderBoard_AS3935 AS3935(2,0x03);
...
// connect the IRQ Grove port to D2 on Arduino
// That corresponds to IRQ 0 on the Arduino
...
void loop()
{
  ...
  if(AS3935IrqTriggered)
  {
    ...
    if (irqSource & 0b1000)
    {
      ...
      if (strokeDistance == 1)
        Serial.println("Storm overhead, watch out! 1Km");
